...
# Define the dataset points and labels
...
# Create a 3-NN classifier and fit it with the training points
...
ax.contourf(xx, yy, predictions, levels=[0.5, 1.5], colors=['lightblue'], alpha=0.5)
...
ax.set_title('3-Nearest Neighbor Classification Regions')
ax.set_xlabel('x')
ax.set_ylabel('y')
